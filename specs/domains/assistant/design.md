# Diseño — Asistente (ASSISTANT)

Decisiones de diseño del dominio **front-only** `assistant`. Referencia: `use-cases.md`,
...
- **Comportamiento de apertura/cierre:**
  ...
  - El estado abierto/cerrado se sigue controlando desde `AssistantService.isOpenDialog()`
    (renombrar a `isOpenPanel()` recomendado en `tasks.md`).
