# Casos de uso — Procesos (PRC) (BACKEND)

> Capa backend (d3brain). Contratos/endpoints aquí. Los pasos de UI (si los hubiera) van en use-cases-front.md.

Dominio: `process`. Paquete `d3.process_designer`. Contrato: §17.

| ID | Nombre | Actor | Estado |
|----|--------|-------|--------|
| CU-PRC-001 | Copiar proceso | Usuario autenticado | ✅ |
| CU-PRC-002 | Gestionar procesos/estados/transiciones | Usuario autenticado | 🔧 |
